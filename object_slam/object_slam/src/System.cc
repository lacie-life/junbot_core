    ...
    mbActivateLocalizationMode(false), mbDeactivateLocalizationMode(false), mbShutDown(false)
{
    ...
    mptLocalMapping = new thread(&semantic_slam::LocalMapping::Run,mpLocalMapper);
    ...
    mptLoopClosing = new thread(&semantic_slam::LoopClosing::Run, mpLoopCloser);
...
void System::SaveTrajectoryTUM(const string &filename)
{
    ...
    list<semantic_slam::KeyFrame*>::iterator lRit = mpTracker->mlpReferences.begin();
...
/*void System::SaveTrajectoryKITTI(const string &filename)
{
    ...
    {
        semantic_slam::KeyFrame* pKF = *lRit;
