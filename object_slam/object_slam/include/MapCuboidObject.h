...
//    class KeyFrame;
    ...
    public:
        ...
        void MergeIntoLandmark(MapCuboidObject *otherLocalObject); // merge the points here. this should already be a landmark. observation should be added elsewhere
        void SetAsLandmark();
        ...
        MapCuboidObject *associated_landmark; // might be itself
